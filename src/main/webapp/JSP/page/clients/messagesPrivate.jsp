                        ...
                        <div class="col p-0 ms-2 justify-content-between">
                            ...
                            <div class="listOfMessage overflow-y-scroll overflow-y-hidden mt-0"
                                ...
                                <div class="message d-flex justify-content-between mt-2 p-2">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3">
                                            <div class="username">Username</div>
                                            <div class="messageUser">Hello World!Hello World!Hello World!Hello
                            ...
                            <div class="insertMessage mt-2">
                                <form action="#" class="d-flex ">
                                    ...
                                    <label for="fichiers" class="custom-file-upload d-flex align-items-center rounded-circle m-auto"><i class="bi bi-file-image"></i></label>
